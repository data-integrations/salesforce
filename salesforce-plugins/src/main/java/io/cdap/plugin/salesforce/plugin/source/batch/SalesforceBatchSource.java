...
import io.cdap.plugin.salesforce.SalesforceAuthUtil;
...
import io.cdap.plugin.salesforce.utils.SalesforceSchemaUtil;
...
public class SalesforceBatchSource extends
  ...
  public void configurePipeline(PipelineConfigurer pipelineConfigurer) {
    ...
    OAuthInfo oAuthInfo = config.containsMacro(SalesforceConstants.PROPERTY_OAUTH_INFO)
      ? null : SalesforceAuthUtil.getOAuthInfo(config.getConnection(), collector);
  ...
  public void prepareRun(BatchSourceContext context) {
    ...
    OAuthInfo oAuthInfo = SalesforceAuthUtil.getOAuthInfo(config.getConnection(), collector);
    ...
    try {
      ...
      String message = SalesforceErrorUtil.getSalesforceErrorMessageFromException(exception);
  ...
  public static Schema getSchema(SalesforceSourceConfig config, OAuthInfo oAuthInfo,
    ...
    try {
      ...
      String errorMessage = SalesforceErrorUtil.getSalesforceErrorMessageFromException(e);
