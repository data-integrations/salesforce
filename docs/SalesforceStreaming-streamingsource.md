...
The plugin can either create a PushTopic for you, or use an existing one.
...
**Topic Name:** Salesforce push topic name. Plugin will track updates from this topic. If topic does
not exist plugin creates it. To manually create pushTopic use Salesforce workbench or
Apex code or API.
