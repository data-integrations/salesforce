...
public class StructuredRecordToCSVRecordTransformerTest {
  ...
  public void testConvertSchemaFieldToStringWithNulValues() {
    assertNull(StructuredRecordToCSVRecordTransformer.convertSchemaFieldToString(null, null));
  }
  ...
  public void testConvertSchemaFieldToString() {
    ...
    assertNotNull(StructuredRecordToCSVRecordTransformer.convertSchemaFieldToString("42", field));
  }
  ...
  public void testTransform() {
    ...
    assertNotNull(csvRecord.getValues());
    assertNotNull(csvRecord.getColumnNames());
  }
}
