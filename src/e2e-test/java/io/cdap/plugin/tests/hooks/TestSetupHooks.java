...
public class TestSetupHooks {
  ...
  public static void createLead() throws UnsupportedEncodingException {
    Map<String, Object> leadResponseInMap =  new HashMap<>();
    ...
    String leadId = SalesforceClient.createLead(lead, "s");
    SalesforceClient.queryLeads(leadId, String.valueOf(SObjects.LEAD));
    PluginPropertyUtils.addPluginProp("dataValidation.query",
                                      "SELECT FirstName, LastName, Company FROM Lead WHERE Id = '" + leadId + "' ");
  }
...
*/
  ...
  @After(order = 1, value = "@BQ_SINK_T")
  public void deleteTempTargetBQTable() throws IOException, InterruptedException {
    String bqTargetTable = PluginPropertyUtils.pluginProp("bqTargetTable");
    try {
