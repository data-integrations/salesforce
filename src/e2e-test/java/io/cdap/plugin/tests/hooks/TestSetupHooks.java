...
import io.cdap.plugin.salesforcestreamingsource.stepsdesign.DesignTimeSteps;
...
public class TestSetupHooks {
  ...
  public static void createTestObject() throws UnsupportedEncodingException, ParseException {
    ...
    SalesforceClient.createObject(testData, customObject);
}
  ...
  public static void createTestObject2() throws UnsupportedEncodingException, ParseException {
    ...
    SalesforceClient.createObject(testObjectData, customObject);
  }
  ...
  public static void deleteTestObject() {
    ...
    SalesforceClient.deleteId(uniqueRecordId, customObject);
  ...
  public static void deleteTestObject2() {
    String uniqueRecordId = SalesforceClient.queryObjectId(customObject2);
    SalesforceClient.deleteId(uniqueRecordId, customObject2);
    BeforeActions.scenario.write("Record - " + uniqueRecordId + " deleted successfully");
